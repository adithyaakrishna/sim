        ...
        <div className='flex flex-col'>
          ...
          <div className='mt-4'>
            {isEnterprise ? (
              <Link
                href={tier.cta.href}
                className='flex h-[32px] w-full items-center justify-center rounded-[5px] border border-[var(--surface-6)] px-2.5 font-[430] font-season text-[var(--text-primary)] text-sm transition-colors hover:bg-[var(--surface-4)]'
              >
                {tier.cta.label}
              </Link>
            ) : isPro ? (
              <Link
                href={tier.cta.href}
                className='flex h-[32px] w-full items-center justify-center rounded-[5px] border border-[#1D1D1D] bg-[#1D1D1D] px-2.5 font-[430] font-season text-sm text-white transition-colors hover:border-[var(--surface-4)] hover:bg-[var(--surface-4)]'
              >
                {tier.cta.label}
              </Link>
            ) : (
