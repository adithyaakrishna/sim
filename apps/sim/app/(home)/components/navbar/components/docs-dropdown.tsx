        ...
        {PREVIEW_CARDS.map((card) => (
          ...
          >
            ...
            <div className='px-2.5 py-2'>
              <span className='font-[430] font-season text-[var(--text-body)] text-small'>
                {card.title}
              </span>
            </div>
          </a>
        ...
        {RESOURCE_CARDS.map((card) => {
          ...
          return (
            <a
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='flex flex-col gap-1 rounded-[5px] border border-[var(--surface-4)] px-2.5 py-2 transition-colors hover:border-[var(--border-1)] hover:bg-[var(--surface-2)]'
            >
              <div className='flex items-center gap-1.5'>
                <Icon className='h-[13px] w-[13px] flex-shrink-0 text-[var(--text-icon)]' />
                <span className='font-[430] font-season text-[var(--text-body)] text-caption'>
                  {card.title}
                </span>
              </div>
              <span className='font-season text-[var(--text-icon)] text-xs leading-[130%]'>
                {card.description}
              </span>
            </a>
          )
