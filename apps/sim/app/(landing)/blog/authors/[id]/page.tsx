  ...
  if (!author) {
    return (
      <main className='mx-auto max-w-[900px] px-6 py-10 sm:px-8 md:px-12'>
        <h1 className='font-[500] text-[var(--landing-text)] text-[32px]'>Author not found</h1>
      </main>
    )
  }
  const personJsonLd = {
  ...
  return (
    <main className='mx-auto max-w-[900px] px-6 py-10 sm:px-8 md:px-12'>
      ...
      <div className='mb-6 flex items-center gap-3'>
        ...
        <h1 className='font-[500] text-[var(--landing-text)] text-[32px] leading-tight'>{author.name}</h1>
      </div>
