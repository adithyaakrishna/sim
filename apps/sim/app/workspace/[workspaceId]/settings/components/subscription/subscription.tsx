...
function CreditPlanCard({
  ...
  return (
    <article className='flex flex-1 flex-col overflow-hidden rounded-md border border-[var(--border-1)] bg-[var(--surface-5)]'>
      <div className='flex items-center justify-between gap-2 px-3.5 py-2.5'>
      ...
      <div className='flex items-center gap-3 border-[var(--border-1)] border-t bg-[var(--surface-4)] px-3.5 py-2.5'>
      ...
      <div className='border-[var(--border-1)] border-t bg-[var(--surface-4)] px-3.5 py-3.5'>
        {isCurrentPlan ? (
  ...
  return (
    <div className='flex h-full flex-col gap-5'>
      ...
      {(subscription.isPaid || (!isLoading && isTeamAdmin)) && (
        <div className='flex flex-col gap-3.5 rounded-md border border-[var(--border-1)] bg-[var(--surface-5)] px-3.5 py-3'>
