    ...
    <div className='flex h-full flex-col gap-[20px]'>
      ...
      <div className='flex flex-col gap-[10px]'>
        ...
        <details className='group overflow-hidden rounded-[6px] border border-[var(--border-1)] bg-[var(--surface-5)]'>
          <summary className='flex cursor-pointer items-center justify-between px-[14px] py-[10px] font-medium text-[15px] text-[var(--text-primary)] hover-hover:bg-[var(--surface-4)] group-open:rounded-b-none'>
