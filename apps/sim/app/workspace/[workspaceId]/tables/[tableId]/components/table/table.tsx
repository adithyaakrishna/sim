      ...
      {isRenaming ? (
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              type='button'
              className='flex h-full w-full min-w-0 cursor-pointer items-center px-2 py-[7px] outline-none'
            >
              <ColumnTypeIcon type={column.type} />
              <span className='ml-1.5 min-w-0 truncate font-medium text-small text-[var(--text-primary)]'>
                {column.name}
              </span>
